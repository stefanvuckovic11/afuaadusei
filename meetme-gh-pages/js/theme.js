...
//    clients_slider();
	...
	var animateProgressBars = function(container) {
		var bars = container.querySelectorAll(".progress-bar");
		bars.forEach(function(bar) {
			var value = bar.getAttribute("aria-valuenow") || 0;
			bar.style.width = "0%";
	...
	var initProgressBars = function() {
		var skillSections = document.querySelectorAll(".skill_main");
		...
		// Fallback: ensure bars animate even if observers fail.
		setTimeout(function() {
			skillSections.forEach(function(section) {
				animateProgressBars(section);
			});
    ...
    function gallery_isotope(){
        if ( $('.gallery_f_inner').length && $.fn.isotope && $.fn.imagesLoaded ){
    ...
    if ( $('#mapBox').length && typeof GMaps !== 'undefined' ){
